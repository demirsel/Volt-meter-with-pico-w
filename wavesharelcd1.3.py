...
pwm.freq(1000)
pwm.duty_u16(60000) # max 65535 - mid value

LCD = LCD_1inch3()
# Background colour - blue
LCD.fill(colour(0,0,255))
LCD.show()
#=========================================================================
...
#===========================================================================================================================================
adcpin=Pin(26,mode=Pin.IN)
adc=ADC(adcpin)

while True:
        
    confac=(3.3/65535)*adc.read_u16()
    format_float = "{:.2f}".format(confac)
    voltstring=str(format_float)
   
   
    ring(120,120,90,colour(255,255,0))
    c = colour(0,25,25) 
    printstring(voltstring+"V",80,110,3,0,0,c) # Easier format
    LCD.show()
    LCD.fill(205)
    utime.sleep(1)
# Tidy up
